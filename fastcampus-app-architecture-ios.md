...
### 04. 회고 문화
- 주간 회고: 매주 한 시간씩 모여서 그 주간에 발생한 버그들을 돌아보고, 근본적인 재발 방지책을 논의.
- Hotfix 회고: 여러 방지책이 있음에도 불구하고 hotfix가 필요했다는 것은 방지책이 충분치 않았다는. Grap에서는 hotfix가 발생하면 그에 대한 리포트를 작성하고 전체 리뷰 시간을 갖는다고.
